export default {
    ...
    detailed_info: {
        ...
        access: "Monthey - Val-d’Illiez - Les Crosets - Vaillime - col des Portes du Soleil. Parking au col (route carrossable). La falaise se trouve à 2 minutes de la voiture à pied.",
        ...
        long_description: "Qui ne connaît pas les Portes du Soleil ? Si nombreux sont ceux qui y tracent de grandes courbes à ski l’hiver, rares sont ceux qui savent qu’un col porte ce nom et soupçonnent l’existence d’une falaise perchée à 1950 m. d’altitude au-dessus des Crosets. Orientée plein sud, elle propose une escalade ensoleillée et variée, en condition de mai à octobre, voire toute l’année (avec une approche à ski), et un point de vue superbe sur les Dents du Midi et le massif des Ruans. Parcourue dès les années 70 par Gilbert Perrin, elle est désormais équipée selon les standards actuels (2003-2006). De nouvelles voies, d’une hauteur de 20 à 35 mètres, ont ainsi vu le jour, avec de petits dévers sympas, parfaits pour celles et ceux qui débutent dans ce type de profil. Même si le rocher est globalement très bon, le port du casque est conseillé. Les “Portes du Soleil” plairont à ceux qui concilient escalade plaisir et pique-nique ainsi qu’aux grimpeurs amateurs de grands espaces.",
    },
    sector_pictures: [
        {
