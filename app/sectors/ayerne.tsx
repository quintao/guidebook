export default {
    ...
    detailed_info: {
        ...
        long_description: "Le Pic d’Ayerne séduira les grimpeurs amateurs de solitude et de calme. Son pied se perd dans a forêt, mais après quelques mètres d’escalade l’horizon se dégage sur les Dent-du-Midi en arrière-plan. Au sommet de « Classico », vous vous tiendrez sur un véritable pic avec une vue magnifique ! Falaise discrète, elle mérite un détour, et même plus d’un si vous vous tentez « Farouche » 7c qui ne se laissera pas facilement dompter !",
    },
    sector_pictures: [
        {
